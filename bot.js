...
client.on('ready', async () => {
 ...
 client.user.setActivity(`Süvari Gaming MTA`)

  
  console.log("Freak Bot Başladı")
});
...
client.on("ready", async () => {
  ...
  let botVoiceChannel = client.channels.cache.get("988369085022765056");
